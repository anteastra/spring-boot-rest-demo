package com.status.externalwebservice;

import com.status.domain.DomainUser;
import com.status.security.AuthenticatedExternalWebService;
import com.status.security.ExternalServiceAuthenticator;
